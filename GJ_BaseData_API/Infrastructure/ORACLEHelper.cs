...
namespace GJ_BaseData_API.Infrastructure
{
    public class ORACLEHelper
    {
        ...
        //public  string connectionString = ConfigurationManager.ConnectionStrings["OleOracleConnect"].ConnectionString;
        public static string connectionString4 = ConfigurationManager.ConnectionStrings["OracleConnectionString4"].ConnectionString;
        //public static string connectionString6 = ConfigurationManager.ConnectionStrings["OracleConnectionString6"].ConnectionString;
        ...
        //public ORACLEHelper(int database)
        //{
        //    if (database == 1)
        //    {
        ...
        //    else
        //    {
        //        throw new Exception($"未配置类型为{database}的数据库");
        //    }
        //}
        #region  执行简单SQL语句
        ...
        public  void RunProcedure(string storedProcName, OracleParameter[] parameters)
        {
            ...
            using (OracleConnection connection = new OracleConnection(connectionString))
            {
                ...
                //cmd.Parameters.Add(new OracleParameter("p_userid", OracleDbType.Int32, 9)).Value = p_userid;
                //cmd.Parameters.Add(new OracleParameter("p_yyyy", OracleDbType.Int32, 7)).Value = p_yyyy;
                //cmd.Parameters.Add(new OracleParameter("p_mm", OracleDbType.Int32, 9)).Value = p_mm;
